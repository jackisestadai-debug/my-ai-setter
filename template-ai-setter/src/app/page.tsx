...
const NICHES: Record<NicheKey, NicheData> = {
  klinik: {
    ...
    conversation: [
      { from: "lead", text: "Hej! Funderar på botox runt ögonen, har aldrig gjort det" },
      { from: "aura", text: "Hej! Vanligt ställe att börja på. Vi kör alltid gratis konsultation först så du vet exakt vad som händer innan du bestämmer dig." },
      { from: "lead", text: "Vad kostar det?" },
      { from: "aura", text: "Från 1 500 kr. Exakt pris beror på område – det går vi igenom på konsultationen." },
      ...
      { from: "aura", text: "Perfekt! Vad är ditt telefonnummer så skickar vi bekräftelsen via SMS?" },
      { from: "lead", text: "070-123 45 67" },
      { from: "aura", text: "Tack! Bokat onsdag 14:00. Bekräftelse skickas till 070-123 45 67 nu." },
    ],
    sms: [
      { from: "lead", text: "Hej, vad kostar botox?" },
      { from: "aura", text: "Hej! Från 1 500 kr. Konsultation alltid gratis. Vilket område?" },
    ...
    email: {
      ...
      messages: [
        { from: "lead", text: "Hej,\n\njag är intresserad av botox runt ögonen men har aldrig gjort det. Vad kostar det och hur lång tid i förväg behöver man boka?\n\nMed vänliga hälsningar" },
        { from: "aura", text: "Hej,\n\nbotox kostar från 1 500 kr. Vi börjar alltid med en gratis konsultation på 20 minuter – du bestämmer dig efteråt.\n\nVi har onsdag 14:00 och torsdag 09:00 ledigt den här veckan.\n\nVilken passar?\n\nMed vänliga hälsningar,\nVår AI-assistent" },
      ],
    },
  },
  coach: {
    ...
    conversation: [
      { from: "lead", text: "Hej! Har försökt träna själv ett tag men ser inga resultat" },
      { from: "aura", text: "Hej! Svårt utan rätt upplägg. Vad är målet – vikt, styrka eller kondition?" },
      { from: "lead", text: "Gå ner i vikt och bli starkare. Kosten är också ett problem" },
      { from: "aura", text: "Då behöver du träning och kostupplägg ihop. Vi anpassar allt efter din vardag." },
      { from: "lead", text: "Har testat PT förut, blev för dyrt" },
      { from: "aura", text: "Förstår. Vi börjar med ett gratis samtal och går igenom vad som passar din budget. Inget köptvång." },
    ...
    sms: [
      ...
      { from: "aura", text: "Hej! Från 450 kr/pass. Gratis samtal först. Vad är målet?" },
      { from: "lead", text: "Gå ner i vikt" },
      { from: "aura", text: "Klart! Måndag 07:00 eller onsdag 17:30?" },
      { from: "lead", text: "Onsdag" },
      { from: "aura", text: "Bokat onsdag 17:30. Vi ses då!" },
    ],
    email: {
      subject: "Fråga om personlig träning",
      messages: [
        { from: "lead", text: "Hej,\n\njag tränar men ser inga resultat. Söker hjälp med både träning och kost. Vad kostar det?\n\nMed vänliga hälsningar" },
        { from: "aura", text: "Hej,\n\nvi erbjuder träning och kostupplägg anpassat efter dig. Alla börjar med ett gratis 30-minuterssamtal.\n\nFrån 450 kr/pass. Vi har måndag 07:00 och onsdag 17:30 ledigt.\n\nPassar något?\n\nMed vänliga hälsningar,\nVår AI-assistent" },
      ],
    },
  },
  artist: {
    ...
    conversation: [
      { from: "lead", text: "Hej! Vi ska gifta oss och letar livemusik till bröllopet" },
      { from: "aura", text: "Hej, grattis! 🎶 Vilket datum?" },
      { from: "lead", text: "14 juni, ca 75 gäster" },
      { from: "aura", text: "14 juni är ledigt. Vi spelar allt från ceremoni till fest och anpassar oss efter er." },
      { from: "lead", text: "Vad kostar det ungefär? Tajt budget" },
      { from: "aura", text: "Beror på hur länge och vilken sättning. Vi gör ett prisförslag efter ett kort samtal, utan förpliktelser." },
      { from: "lead", text: "Okej, vi bokar ett samtal" },
      { from: "aura", text: "Toppen! Tisdag 10:00 eller torsdag 13:00?" },
      { from: "lead", text: "Torsdag" },
      { from: "aura", text: "Perfekt! Vad är er mailadress så vi kan skicka bekräftelsen?" },
      { from: "lead", text: "sara@exempel.se" },
      { from: "aura", text: "Klart! Bokat torsdag 13:00. Bekräftelse skickas till sara@exempel.se." },
    ],
    sms: [
      { from: "lead", text: "Hej! Lediga för bröllop 14 juni?" },
      { from: "aura", text: "Hej! Ja, 14 juni är ledigt. Hur många gäster?" },
      { from: "lead", text: "Ca 75" },
      { from: "aura", text: "Perfekt. Tisdag 10 eller torsdag 13 för ett snabbt samtal?" },
      { from: "lead", text: "Torsdag passar" },
      { from: "aura", text: "Bokat! Torsdag 13:00. Vi ses då." },
    ],
    email: {
      subject: "Förfrågan – livemusik bröllop 14 juni",
      messages: [
        { from: "lead", text: "Hej,\n\nvi planerar bröllop 14 juni och söker livemusik för ca 75 gäster. Vad kostar det?\n\nMed vänliga hälsningar" },
        { from: "aura", text: "Hej och grattis!\n\n14 juni är ledigt. Vi anpassar musik och tid helt efter er – från ceremoni till fest.\n\nOffert sätts ihop efter ett kort samtal. Vi har tisdag 10:00 och torsdag 13:00 ledigt.\n\nPassar något?\n\nMed vänliga hälsningar,\nVår AI-assistent" },
      ],
    },
  },
  maklare: {
    ...
    conversation: [
      { from: "lead", text: "Hej! Har letat hus i ett år, inget passar" },
      { from: "aura", text: "Hej! Tuff marknad. Vad är viktigast – storlek, läge eller pris?" },
      { from: "lead", text: "5 rum, trädgård, nära stan. Budget 6 miljoner" },
      { from: "aura", text: "Vi har objekt på gång som inte är publicerade än och matchar det." },
      { from: "lead", text: "Hört det förut, inget har hänt" },
      { from: "aura", text: "Förstår skepticismen. Boka ett möte så visar vi exakt vilka objekt – inga löften utan bevis." },
      { from: "lead", text: "Okej. När?" },
      { from: "aura", text: "Torsdag 10:00 eller fredag 13:00?" },
      { from: "lead", text: "Fredag" },
      { from: "aura", text: "Bra! Vad är er mailadress för bekräftelsen?" },
      { from: "lead", text: "info@familjensson.se" },
      { from: "aura", text: "Klart! Möte fredag 13:00. Bekräftelse skickas till info@familjensson.se." },
    ],
    sms: [
      { from: "lead", text: "Hej, söker villa 5 rum, trädgård, nära stan, 6M" },
      { from: "aura", text: "Hej! Vi har matchande objekt på gång. Max hur långt från centrum?" },
    ...
    email: {
      ...
      messages: [
        { from: "lead", text: "Hej,\n\nvi letar villa med 5 rum och trädgård, max 20 min från centrum. Budget ca 6 miljoner. Har ni något?\n\nMed vänliga hälsningar" },
        { from: "aura", text: "Hej,\n\nvi har objekt på gång som matchar – ett av dem är inte publicerat ännu.\n\nFöreslår ett kort möte på 30 min så vi kan visa vad vi har.\n\nTorsdag 10:00 eller fredag 13:00 – fungerar något?\n\nMed vänliga hälsningar,\nVår AI-assistent" },
      ],
    },
  },
  byra: {
    ...
    conversation: [
      { from: "lead", text: "Hej! Vi lägger pengar på annonser men ser inga resultat" },
      { from: "aura", text: "Hej! Vanligt problem. Vad säljer ni och till vem?" },
      { from: "lead", text: "Redovisning till småföretag, kör Meta-annonser" },
      { from: "aura", text: "Stark målgrupp om det sätts upp rätt. Vet ni vad en ny kund är värd för er?" },
      { from: "lead", text: "Ca 20 000 kr/år" },
      { from: "aura", text: "Då finns det stor potential. Vi gör en gratis genomgång av era annonser och visar vad som kan förbättras." },
      { from: "lead", text: "Vi har testat byråer förut med dåligt resultat" },
      { from: "aura", text: "Förstår. Därför kostar genomgången inget och ni ser konkret vad vi hittar innan ni bestämmer er." },
      { from: "lead", text: "Okej, det låter rimligt. När?" },
      { from: "aura", text: "Onsdag 09:00 eller fredag 13:00?" },
      { from: "lead", text: "Onsdag" },
      { from: "aura", text: "Toppen! Vad är er mailadress för bekräftelsen?" },
      { from: "lead", text: "hej@redovisning.se" },
      { from: "aura", text: "Klart! Bokat onsdag 09:00. Bekräftelse skickas till hej@redovisning.se." },
    ],
    sms: [
      { from: "lead", text: "Hej, kör Meta-annonser men får inga kunder" },
      { from: "aura", text: "Hej! Vad säljer ni och vad är en kund värd?" },
    ...
    email: {
      ...
      messages: [
        { from: "lead", text: "Hej,\n\nvi kör Meta-annonser men ser lite avkastning. Vet inte om det är målgruppen eller budskapet. Vad erbjuder ni?\n\nMed vänliga hälsningar" },
        { from: "aura", text: "Hej,\n\nbetyder troligtvis för bred målgrupp eller fel budskap – de vanligaste orsakerna.\n\nVi börjar med en gratis genomgång av era annonser. Ni ser vad vi hittar innan ni bestämmer er – inget köptvång.\n\nOnsdag 09:00 eller fredag 13:00 – passar något?\n\nMed vänliga hälsningar,\nVår AI-assistent" },
      ],
    },
  },
  restaurant: {
    ...
    conversation: [
      { from: "lead", text: "Hej! Kan man boka bord för 12 nästa lördag? Vi ska fira 40-årsdag" },
      { from: "aura", text: "Hej, vad kul! 🎂 Nästa lördag har vi plats. Har ni några önskemål?" },
      { from: "lead", text: "Kan man beställa tårta?" },
      { from: "aura", text: "Absolut! Vi kan också lägga ett välkomstglas på bordet om ni vill." },
      ...
      { from: "aura", text: "Toppen! Vad är din mailadress för bekräftelsen?" },
      { from: "lead", text: "anna@exempel.se" },
      { from: "aura", text: "Klart! Anna Lindström, 12 pers, lördag 18:00 med tårta. Bekräftelse skickas till anna@exempel.se." },
    ],
    sms: [
      { from: "lead", text: "Hej, bord för 12 nästa lördag?" },
      { from: "aura", text: "Hej! Ja, vi har plats. Vilket tillfälle?" },
    ...
    email: {
      ...
      messages: [
        { from: "lead", text: "Hej,\n\nvi vill boka bord för 12 nästa lördag för ett 40-årsdagsfirande. Går det och erbjuder ni tårta?\n\nMed vänliga hälsningar" },
        { from: "aura", text: "Hej och grattis på 40-årsdagen!\n\nVi har plats för 12 nästa lördag. Vi erbjuder tårta och välkomstglas mot tillägg.\n\n18:00 brukar passa bra för en grupp. Vilket namn och klockslag?\n\nMed vänliga hälsningar,\nVår AI-assistent" },
      ],
    },
  },
};
    ...
    <>
      ...
      <section ref={processRef} className="section">
        <div className="container">
          ...
          <h2 className="section__h2">Från idé till verklighet på 7 dagar</h2>
