/**
 * Glow Studio Demo — live DM-showcase.
 * Powrar DemoDM-panelen i HQ: besökaren skriver som en patient,
 * Ella (klinik-demo AI-receptionist) svarar med sin riktiga system-prompt.
 *
 * POST /api/klinik-demo/demo-dm?k=<key>
...
const OPENER = "Hej! Välkommen till Glow Studio 🌸 Vad kan jag hjälpa dig med idag?";
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("[klinik-demo/demo-dm] error:", err);
    return NextResponse.json({ messages: [OPENER] });
  }
}
