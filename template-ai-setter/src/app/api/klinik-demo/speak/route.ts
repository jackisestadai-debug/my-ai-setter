/**
 * Glow Studio Demo — TTS via ElevenLabs.
 * Samma röst och inställningar som owner HQ men validerar mot demo-nyckeln.
 *
 * POST /api/klinik-demo/speak?k=<key>  body: { text }  → audio/mpeg
 * GET  /api/klinik-demo/speak?k=<key>&text=<text>       → audio/mpeg
 */
