...
function HqStyles() {
  return (
    <style>{`
      ...
      .hq-tab.on { color: #0d0d0d; background: linear-gradient(90deg,#7eb8d4,#4a90b8); border-color: transparent; font-weight: 800; box-shadow: 0 0 22px rgba(201,168,76,0.35); }
